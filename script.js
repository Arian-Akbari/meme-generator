function clearAll() {
    ...
    if (document.getElementById("joke") !== null) {
...
function showMeme() {
    ...
    let p = document.querySelectorAll('h1').item(2);
    console.log(p);
...
function showJoke() {
    ...
    let p = document.querySelectorAll('h1').item(3);
    let parent = document.querySelector('.content');
    let joke = document.createElement('p');
    joke.textContent = randomJokeText;
    joke.id = "joke";
    parent.insertBefore(joke, p);
}

function showQuote() {
    clearAll();
    const randomQuote = getRandomData("quotes");
    let p = document.querySelectorAll('h1').item(4);
    let parent = document.querySelector('.content');
    let quote = document.createElement('p');
    quote.textContent = randomQuote.quote;
    quote.id = "quote";
    parent.insertBefore(quote, p);
    let author = document.createElement('p');
    author.textContent = randomQuote.author;
    author.id = "author";
    parent.insertBefore(author, p);
}
...
function showRiddle() {
    ...
    let p = document.querySelectorAll('h1').item(5);
    let parent = document.querySelector('.content');
    let question = document.createElement('p');
    question.textContent = randomRiddle.question;
    question.id = "question";
    parent.insertBefore(question, p);
    let answer = document.createElement('p');
    answer.textContent = randomRiddle.answer;
    answer.id = "answer";
    parent.insertBefore(answer, p);
